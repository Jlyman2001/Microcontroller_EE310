;---------------------
; Title: 7 Segment Up-Down Counter (Assignment 6)
;---------------------
; Program Details: Displays a number on a seven segment display that can be 
; incremented or decremented via two buttons as well as reset by pressing both
; 
; Inputs: Pins B0 and B1 attached to input buttons with a pulldown resistor
