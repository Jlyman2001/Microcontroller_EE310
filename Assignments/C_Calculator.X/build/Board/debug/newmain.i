...
signed char input_X,input_Y,Operation,Result,key;

signed char getKeypress(void)
{
...
signed char evaluate(input_X,input_Y,Operation)
{
...
void display(signed char Result)
{
    PORTD = Result;
}
